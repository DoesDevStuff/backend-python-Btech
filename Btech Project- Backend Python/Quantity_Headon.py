...
qtuple1 = (93000,93000)
qtuple2 = (115000,115000)
qtuple3 = (70000,151000)
qtuple4 = (171000,70000)

#checking quatity lauch matrix values
def checkq(qtup):
    if qtup == tuple1:
        qtup = qtuple1
        return qtup
...
py.plot(fig1, filename = '[Quantity] Co-operation Vs. Defection Count', auto_open=False)
#====================================================================================
...
#plot(fig)
py.plot(fig, filename = '[Quantity] Scatter Plot: Player Score per Match', auto_open=False)
...
py.plot(figb, filename = '[Quantity] Bar Plot: Player Score per Match', auto_open=False)
#================================================================================
# figs = go.Figure()
